...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_list:
        ...
        f"This represents {(county_votes[county]/total_votes)*100} % of the total vote. "
        )
    ...
    top_turnout = f"The county with the highest turnout is {largest_county_turnout} with {highest_turnout} votes and {(highest_turnout/total_votes)*100}% turnout."
